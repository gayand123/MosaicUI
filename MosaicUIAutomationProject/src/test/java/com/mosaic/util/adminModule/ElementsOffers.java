...
public class ElementsOffers {
    ...
    public static final String lblSelectOrderTotalOffer = "//*[@id='menu-offerType']/div[3]/ul/li[3]";
    ...
    public static final String txtDiscountAmount ="//input[@name='inputParamList.2.value']";
